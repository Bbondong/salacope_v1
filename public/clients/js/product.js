...
document.getElementById('contactBtn').addEventListener('click', async () => {
  ...
  try {
    ...
    if (!data.logged_in) {
      ...
      const chatUrl = `index.php?page=Chat&seller=${currentProduct.seller_id}&product=${productId}&seller_type=${currentProduct.seller_type}`;
    ...
    window.location.href = 
      `index.php?page=Chat&seller=${currentProduct.seller_id}&product=${productId}&client=${clientId}&seller_type=${currentProduct.seller_type}`;
